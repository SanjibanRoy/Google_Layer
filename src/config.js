...
export const layer = [
  //Administrator boundary start
  {
    ...
    info:  "This layer displays the state boundaries of the North East states of India.",
  ...
  },
  {
    ...
    info: "This layer displays the district boundaries of the North East states of India.",
    link: "https://apps.nesdr.gov.in:442/geoserver/wms",
    attributes: [
  ...
  },
  {
    ...
    info: "This layer displays the revenue circle boundaries of the North East states of India.",
  ...
  // Land Use and Land Cover Start
  {
    ...
    info: "These data describe land use and cover type, and are based on 2005-2006 year. It is prepared by using satellite data of IRS-LISS-III with spatail resolution of nearly 24m",
    stats: true,
    clayer: "lege",
  ...
  },
  {
    ...
    link: "https://www.nesdr.gov.in/igistile/NER_Land_Use_50K_QC_passWS/wms",
    info: "These data describe land use and cover type, and are based on 2011-2012 year.",
    clayer: "lege",
  ...
  },
  {
    ...
    link: "https://www.nesdr.gov.in/igistile/NER_Land_Use_50K_QC_passWS/wms",
    info: "These data describe land use and cover type, and are based on 2015-2016 year. These data prepared by using IRS-AWiFS satellite at 1: 250000 scale. This map is generated by choosing, for each pixel, the land cover classification with the spatial resolution of 56 meters.",
    clayer: "lege",
  ...
  },
  {
    ...
    info :"This layer represents the erosion and deposition of Brahmaputra river. The GIS map represents erosion area of about 739 Sq.km and deposition area of 209 Sq.km measured from year 1988 to 2016.",
    attributes: [
      { value: "name", text: "Name" },
      { value: "length_km", text: "Length (Km)" },
      { value: "distance", text: "Distance" },
  ...
  },
  {
    ...
    class: "Flood",
    subclass: "Flood",
    info: "This layer represents flood inundation as generated by using IRS, LISS-III data. These maps represent the date wise flood inundation area in Assam.",
  ...
  },
  {
    ...
    link: "https://apps.nesdr.gov.in:442/geoserver/FLEWS/wms",
    info: "The state of Assam is fully covered by the Brahmaputra and Barak basins. A severe flood event affected Lakhimpur district of Assam during June, 2008 causing enormous damage. NESAC was formally requested by Govt. of Assam and the North Eastern Council (NEC) to develop an operational flood warning system at district level in Assam. The project FLEWS was initiated for Lakhimpur district as pilot during 2009-10. Today, the project covers all flood prone districts of Assam with actionable flood alerts in revenue circle level. The objective of this project is, using the strength of geospatial technology coupled with satellite and ground based hydro-meteorological analysis for issue of actionable alerts and advisories to state and district administration for risk reduction and management of flood in Assam.All these years since the beginning, an average year to year alert success score of 75% and an average alert to alert lead time of 24 to 36 hours have been maintained. Being the first operational GIS based hydro-met warning system in the country, this scheme of NESAC has been able to get both national and regional level recognition such as Good Governance Initiative and professional best practiceby Union Ministry of Public Grievances and Pensions, Govt. of India as well as winner of E-North East award for E-governance and Citizen services delivery etc. This scheme has generated enough interest in the country that a good numbers Parliament questions (both from LOK SABHA & RAJYA SABHA) have been answered by NESAC / ISRO on this scheme.",
    stats: {
    },
    attributes: [
  ...
  },
  {
    ...
    show: false,
    class: "Alerts and Early Warning",
    subclass: "alertlightning",
    info: "NESAC initiated a Numerical weather prediction model based lightning forecast overall the eight North Eastern States during the pre-monsoon season 2019 onwards. The model forecasted lightning Flash origin density (FOD) is circulated for different hours in UTC (IST+5:30 Hour) with all concerned people and also uploaded on the NERDRR website. The unit of FOD is flash per grid cell per time interval (here grid cell resolution is 3 km). This parameter provides lightning flash density overlaid on North-East India’s map. NESAC is also subscribed Earth Networks Lightning Location-datasets to track the lightning positions over the whole of North East India. To improve the model forecast of lightning with maximum possible lead time (considering the location and temporal accuracy) NESAC has first time in India assimilated the ground-based lightning data into the WRF model and improved the model forecast significantly.",
    layer: "",
    stats: "",
    layer_date: "",
    link: "https://analytics.nesdr.gov.in/nerdrr_lightning/lightning",
    options: [
      { value: "", text: "select" },
      { value: "1", text: "11 UTC" },
      { value: "2", text: "12 UTC" },
  ...
  },
  {
    ...
    attributes: [
      ...
      { value: "occurencetime", text: "Time" },
      { value: "eqdepth", text: "Earthquake Depth" },
      { value: "mag", text: "Magnitude" },
      { value: "mag", text: "Magnitude" },
      { value: "magtype", text: "Magnitude Type" },
  ...
  {
    id: 26,
    text: "CropDams (River Bank Erosion)",
    show: false,
    class: "CropDAMS",
  ...
  {
    id: 37,
    text: "CropDams (Districtwise Erosion)",
    show: false,
    class: "CropDAMS",
    subclass: "cropDAMS",
    layer: "",
  ...
  // },
  {
    ...
    link:"https://geoserver.nesdr.gov.in:442/geoserver/NERDRR_NEW/wms",
    info: "This layer displays the masked view of the North East states of India",
  },
];
...
export const maps = [
  ...
  },
  {
    ...
    show: true,
    class: "Maps",
    layer: "	NERDRR:cartodem_ner",
    link: "https://apps.nesdr.gov.in:442/geoserver/NERDRR/wms",
    format: "image/png",
    // domain: ["mt0", "mt1", "mt2", "mt3"],
    image: "terrain.png",   
  }
